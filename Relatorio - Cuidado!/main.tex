...
\begin{info}
    \begin{itemize}
        ...
        \item Da travessia desde a raiz, até a uma folha, resultam todas as dependências que um certo objecto tem na \textbf{scene} em questão. Garantindo eficiência de operações de edição da \textbf{scene} sem replicação de memória.
    \end{itemize}
\end{info}
